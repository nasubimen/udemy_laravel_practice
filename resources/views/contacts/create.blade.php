                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <select name="age">
                                                    ...
                                                    <option value="1" {{old('age'=== 1 ? 'selected' : '')}}>10代</option>
                                                    <option value="2" {{old('age'=== 2 ? 'selected' : '')}}>20代</option>
                                                    <option value="3" {{old('age'=== 3 ? 'selected' : '')}}>30代</option>
                                                    <option value="4" {{old('age'=== 4 ? 'selected' : '')}}>40代</option>
                                                    <option value="5" {{old('age'=== 5 ? 'selected' : '')}}>50代</option>
                                                    <option value="6" {{old('age'=== 6 ? 'selected' : '')}}>60代</option>
